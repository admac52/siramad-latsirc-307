	...
	do{
		...
		switch(op1){
			case 1:{cout<<"\n\t\t***** TRIANGULOS *****"<<endl;
					...
					if(cl==3 and ca==0){cout<<"\t\ta) Tres lados"<<endl<<endl;// LEY DE COSENOS
						if((((pow((lado[3]),2))+(pow((lado[1]),2))-(pow((lado[2]),2)))/(2*lado[3]*lado[1]))>1){
							cout<<"\t\tNO ES POSIBLE CALCULAR..."<<endl;
							cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
						}
						angulo[3]= acos( double (((pow((lado[3]),2))+(pow((lado[1]),2))-(pow((lado[2]),2)))/(2*lado[3]*lado[1])));angulo[3]=angulo[3]*180/PI;
						if(((((pow((lado[2]),2))+(pow((lado[1]),2))-(pow((lado[3]),2)))/(2*lado[2]*lado[1])))>1){
							cout<<"\t\tNO ES POSIBLE CALCULAR..."<<endl;
							cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
						}
					...
					if(ca==3 and cl==0){cout<<"\t\tb) Tres angulos"<<endl<<endl;
						cout<<"\t\tNO ES POSIBLE CALCULAR..."<<endl;
					...
					if(cl==2 and ca==1){cout<<"\t\tc) Dos lados y un angulo"<<endl<<endl;
						for(int i=1;i<=3;i++){
							if(gl[i]==1 and gl[i+1]==2 and ga[i]==1){// LEY DE COSENOS Y LEY DE SENOS
								if((pow((lado[1]),2)+(pow((lado[2]),2))-(2*lado[1]*lado[2]*(cos(double (angulo[1]*(PI/180))))))<0){
									cout<<"\t\tUNA RAIZ NO ES POSIBLE CALCULAR..."<<endl;
									cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
								}
								lado[3]= sqrt(pow((lado[1]),2)+(pow((lado[2]),2))-(2*lado[1]*lado[2]*(cos(double (angulo[1]*(PI/180))))));
								if((((lado[2]*(sin(double (angulo[1]*(PI/180)))))/lado[3]))>1){
									cout<<"\t\tUNA FUNCION NO ES POSIBLE CALCULAR..."<<endl;
									cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
								}
							...
							if(gl[i]==1 and gl[i+1]==3 and ga[i]==1){// LEY DE SENOS
								if((((lado[1]*(sin(double (angulo[1]*(PI/180)))))/lado[3]))>1){
									cout<<"\t\tUNA FUNCION NO ES POSIBLE CALCULAR..."<<endl;
									cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
								}
								angulo[2]= asin(double ((lado[1]*(sin(double (angulo[1]*(PI/180)))))/lado[3]));angulo[2]=angulo[2]*180/PI;
							...
							if(gl[i]==1 and gl[i+1]==2 and ga[i]==2){// LEY DE SENOS
								if((((lado[2]*(sin(double (angulo[2]*(PI/180)))))/lado[1]))>1){
									cout<<"\t\tUNA FUNCION NO ES POSIBLE CALCULAR..."<<endl;
									cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
								}
							...
							if(gl[i]==1 and gl[i+1]==3 and ga[i]==2){// LEY DE SENOS
								if((((lado[3]*(sin(double (angulo[2]*(PI/180)))))/lado[1]))>1){
									cout<<"\t\tUNA FUNCION NO ES POSIBLE CALCULAR..."<<endl;
									cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
								}
							...
							if(gl[i]==2 and gl[i+1]==3 and ga[i]==2){// LEY DE COSENOS Y LEY DE SENOS
								if((pow((lado[2]),2)+(pow((lado[3]),2))-(2*lado[2]*lado[3]*(cos(double (angulo[2]*(PI/180))))))<0){
									cout<<"\t\tUNA RAIZ NO ES POSIBLE CALCULAR..."<<endl;
									cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
								}
							...
							if(gl[i]==1 and gl[i+1]==2 and ga[i]==3){// LEY DE SENOS
								if((((lado[1]*(sin(double (angulo[3]*(PI/180)))))/lado[2]))>1){
									cout<<"\t\tUNA FUNCION NO ES POSIBLE CALCULAR..."<<endl;
									cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
								}
							...
							if(gl[i]==2 and gl[i+1]==3 and ga[i]==3){// LEY DE SENOS
								if(((((lado[3]*(sin(double (angulo[3]*(PI/180)))))/lado[2])))>1){
									cout<<"\t\tUNA FUNCION NO ES POSIBLE CALCULAR..."<<endl;
									cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
								}
					...
					if(cl==1 and ca==2){cout<<"\t\td) Dos angulos y un lado"<<endl<<endl;
						for(int i=1;i<=3;i++){	
							if(gl[i]==1 and ga[i]==1 and ga[i+1]==2){// LEY DE COSENOS Y LEY DE SENOS
								angulo[3]=180-angulo[1]-angulo[2];
								lado[3]= lado[1] * (sin(double (angulo[1]*(PI/180))))/(sin(double (angulo[2]*(PI/180))));
								if((pow((lado[1]),2)+(pow((lado[3]),2))-(2*lado[1]*lado[3]*(cos(double (angulo[3]*(PI/180))))))<0){
									cout<<"\t\tUNA RAIZ NO ES POSIBLE CALCULAR..."<<endl;
									cout<<"\t\tLOS DATOS INGRESADOS SON INCOMPATIBLES"<<endl;
								}
					...
					if((cl+ca)>3){
						cout<<"\tPOR FAVOR SOLO INGRESE TRES DATOS, PUEDE CAUSAR INCOMPATIBILIDAD"<<endl<<endl;
					}cout<<"\n";cout<<"\n";
				// ******* TODOS *******
					// AREA
					area=0.5*lado[1]*lado[2]*((sin(double (angulo[1]*(PI/180)))));
					// MEDIANAS
